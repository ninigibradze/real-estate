    ...
    <section>
      <div className='container mx-auto min-h-[800px] mb-14' >
        <div className='flex flex-col lg:flex-row lg:items-center justify-between'>
          ...
          <div className='mb-4 lg:mb-9 flex gap-x-2 text-sm'>
        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'>
          ...
          border-gray-300 rounded-lg px-6 py-8'>
            <div className='flex items-start gap-x-4 mb-8'>
              <div className='w-20 h-20 p-1 borders border-gray-300 rounded-full'>
                <img src={house.agent.image} alt='houseagentimg' />
              </div>
              <div>
